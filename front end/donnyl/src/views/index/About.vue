 ...
 * @LastEditTime: 2021-09-07 11:11:46
      ...
      <div class="about">
          ...
          <div class="about-content">
              ...
              <div class="about-personal-details" v-for="(item,i) in detailslist" key="i">
                  <span class="about-details-hd">{{item.title}}</span>
...
<script>
    export default {
        data() {
            return {
                detailslist: [
                    {title:'Fullname',content:'Fangsai Li'},
                    {title:'Nickname',content:'Donny'},
                    {title:'Father\'s Name',content:'Wengbing Li'},
                    {title:'Address',content:'China Wubei Ezhou Yanglanguojikangcheng 31'},
                    {title:'Zip Code',content:'436000'},
                    {title:'Phone',content:'+86 19512102264'},
                    {title:'Email',content:'1340710624@qq.com , k1814426@kcl.ac.uk'},
                    {title:'Website',content:'https://donnyl.top'},
